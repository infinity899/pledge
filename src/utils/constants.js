export const RewardStatus = {
  ...
  DONATION: 'donation', // Donation mode
};
...
const KYCMessageKeys = {
  SUCCESS: 0,
  NO_CONTACT: 1,
  URL_FAIL: 2,
  REMOVE_CONFIRMATION: 3,
};

export const KYCMessages = Object.keys(KYCMessageKeys)
  .reduce((obj, key) => {
    obj[KYCMessageKeys[key]] = key.toLowerCase();
    return obj;
  }, KYCMessageKeys);
